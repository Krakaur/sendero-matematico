# Privacidad de Sendero

Versión del aviso: 15 de septiembre de 2026. Desarrollo: Dirk Hans Krakaur Floranes. Contacto público sobre el software: [repositorio de Sendero](https://github.com/Krakaur/sendero-matematico/issues). No publiques nombres, expedientes ni informes de menores en ese canal.
...
Los códigos persistentes, fechas y secuencias de práctica pueden permitir vincular registros. Los informes no deben denominarse anónimos. Su relación con nombres o expedientes escolares debe mantenerse fuera del repositorio público y bajo control institucional.

## Web y enlaces externos

La versión web se aloja en GitHub Pages. Al abrirla, GitHub puede procesar datos técnicos de acceso conforme a su [declaración de privacidad](https://docs.github.com/es/site-policy/privacy-policies/github-general-privacy-statement). Eso no implica que GitHub reciba el contenido de los informes guardados localmente. Los enlaces a documentación o descargas abren sitios externos, con sus propias prácticas de tratamiento.

## Borrado y cambios de finalidad
