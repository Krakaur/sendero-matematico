...
La ejecución final [35014294685](https://github.com/Krakaur/sendero-matematico/actions/runs/35014294685) terminó correctamente con las fuentes de publicación: compilación Release de APK/AAB, firma, verificación de assets, Lint e integración en Android 15/API 35. La prueba separa la acción de navegar de la consulta de su resultado visible, evitando depender de callbacks que WebView puede descartar durante una navegación. El AAB también pasó `bundletool validate` con bundletool 1.18.3. Los tamaños y huellas definitivos están en `BUILD_MANIFEST.json`.

La web publicada se comprobó por correspondencia SHA-256 del módulo principal y por interfaz: al cerrar y volver a abrir tras activarse la actualización, aparecieron los enlaces Android y Windows de 0.1.1, con el mismo código de perfil local. La preparación sin conexión permaneció indicada. No fue necesario borrar los datos del navegador.
