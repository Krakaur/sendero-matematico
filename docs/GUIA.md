...
La pista representa las cantidades con grupos visuales o propone una descomposición. Una respuesta incorrecta permite otro intento. Todos los intentos se conservan. La recompensa corresponde a completar los ocho pasos, independientemente de la cantidad de pistas. Pausar conserva el ejercicio; continuar recupera sus respuestas y ayudas. Cambiar de camino con una aventura pendiente pide confirmación para abandonar esa aventura incompleta.
