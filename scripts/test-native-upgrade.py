...
(OUT/'upgrade.json').write_text(json.dumps({'from':'0.2.0','to':'0.4.0','samePackageAndSignature':True,'profileAndPasswordPreserved':True,'pendingAnswerPreserved':True},indent=2))
