...
function render(persistState = true) {
  ...
  $('#sound').textContent=state.sound?'Sonido activado':'Sonido';
  bindProfiles();
  startTimer();
}
function goGame() {
