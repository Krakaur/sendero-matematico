...
[Abrir el juego](https://krakaur.github.io/sendero-matematico/) · [Descargar Windows](https://github.com/Krakaur/sendero-matematico/releases/latest) · [Guía de uso](docs/GUIA.md) · [Evaluación](docs/EVALUACION.md)

![Luma explora un sendero entre montañas](web/social.png)

Sendero es un juego gratuito de práctica matemática, desarrollado por Dirk Hans Krakaur Floranes. Está orientado a primaria, con navegación móvil y funcionamiento en laptop. Las aventuras de ocho ejercicios ofrecen sumas, restas y multiplicación, pistas visuales y cuatro niveles de dificultad adaptativa. El juego no impone un límite de tiempo ni penaliza la solicitud de ayuda.
...
La rama `main` conserva fuentes, pruebas y documentación. La rama `gh-pages` contiene únicamente el sitio estático. Las descargas de Windows se distribuyen mediante Releases para mantener ligera la web.

## Documentación y colaboración

[Guía de familias y docentes](docs/GUIA.md), [diseño y límites técnicos](docs/DISENO.md), [tres ciclos de evaluación](docs/EVALUACION.md), [estrategia de difusión](docs/DIFUSION.md) y [citación](CITATION.cff).
